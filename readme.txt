...
3)Then Client is asked for a Nick Name.(You shouldn't give a nickname which is already used because it will not be accepted). If you give a used nick name, Server will show the list of used nicknames and again ask you to enter nick name.
